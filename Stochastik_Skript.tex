...
\section{Dynkin Systeme und Sätze über monotone Klassen} % Abschnitt 11
...
\begin{defn} \index{Dynkin-System} % flashcard-name: Was muss gelten für einDynkinsystem
...
\end{example}
%\textbf{Satz 11.7 }\emph{über monotone Klassen}\\
...
\marginpar{Vorlesung 26.6.2013} $X_{1},X_{2},\ldots$ unabhängige
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Vorlesung 1.7.2013 Ausgelassen
...
\paragraph*{\protect\marginpar{Vorlesung 3.7.2013}Setup: }
...
\]
eine \index{Stichprobe}Stichprobe, d.h. $\left(X_{i}\right)$ i.i.d.
bzgl. $\mathbb{P}_{\theta_{0}}$ wobei $\theta_{0}$ \index{wahrer Parameter}
...
\]
\index{Schätzer}\emph{Schätzer} für $g\left(\theta\right)$.
\end{defn}
Typisches Beispiel
\[
...
heißt \index{erwartungstreu}\emph{erwartungstreu}, falls 
\[
...
\]
heißt \index{systematischer Fehler}\emph{systematischer Fehler} oder
\index{Bias}Bias.\end{defn}
\begin{example}
...
\]
wir definieren die \emph{\index{Likelihoodfunktion}Likelihoodfunktion:}
\begin{description}
...
\]
die \emph{Likelihoodfunktion}\index{Likelihoodfunktion} des statistischen
